...
func newTestConfig() config2.Config {
	return config2.Config{
		Merchant: config2.Merchant{MchID: "0002900F0370542"},
		Cert: config2.Cert{
			RsaPrivate: testRsaPrivate,
			RsaPublic:  testRsaPublic,
		},
		API: config2.API{ApiHost: "https://richOperationFront-test.fuioupay.com"},
	}
}
